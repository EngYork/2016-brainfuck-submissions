Answer to the Easy challenge extension for ShockSoc's brainfuck competition
...
For the extension we don't want to include the multiples of 15 at 
all so we subtract twice their value!
